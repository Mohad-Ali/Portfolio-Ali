...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mohammed-ali-0438a730a",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Mohad-Ali",
    icon: Instagram,
    url: "https://www.instagram.com/half_blood_prinzz___",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Mohad-Ali",
    icon: Github,
    url: "https://github.com/Mohad-Ali",
    color: "#ffffff",
  ...
  },
  {
    ...
    color: "#2164F3",
    gradient: "from-[#0A66C2] to-[#2164F3]"
  }
];
...
const SocialLinks = () => {
  ...
  const [instagram, WhatsApp, github, SiIndeed] = otherLinks;
...
>
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent
        ...
        {/* Third Row - GitHub & SiIndeed */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[github, SiIndeed].map((link) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
