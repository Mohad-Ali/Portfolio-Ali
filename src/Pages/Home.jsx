...
const WORDS = ["Network & Freelancing", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Mongodb", "Tailwind Css"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Mohad-Ali" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/mohammed-ali-0438a730a/" },
  { icon: Instagram, link: "https://www.instagram.com/half_blood_prinzz___" }
];
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[6%] mt-10 md:mt-6 ml-0 md:ml-10 min-h-screen">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Developing Innovative, Functional, and User-Friendly Software for Digital Solutions.
                </p>
